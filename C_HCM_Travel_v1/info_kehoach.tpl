...
<div class="w3-container" style="clear: left;">
      ...
      <button class="w3-btn w3-white w3-border w3-border-red w3-round-xlarge">  <a href="http://localhost:8080/C_HCM_Travel_v1/#/Map_HCM_C" target="blank" >Xem thông tin chi tiết</a></button>
</div>
</div>
