...
//        icon:'../C_HCM_Travel_v1/public/map_libs/img/icon/Travel_baloon_icon48.png'
   ...
   uiGmapGoogleMapApi.then(function () {
      ...
      $http.get('./loai_place.json').then(function (response) {
        $scope.loai_place = response.data.features;
      });
   ...
   uiGmapGoogleMapApi.then(function () {
    ...
    uiGmapGoogleMapApi.then(function () {
      ...
      $http.get('./kehoach_thamkhao.json').then(function (response) {
       ...
       $http.get('./hinh_anh.json').then(function (response) {
        $scope.hinh_anh = response.data.features;
      });
