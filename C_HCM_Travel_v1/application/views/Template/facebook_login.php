...
<div class="dropdown">
  ...
  <div class="dropdown-content">
    <p><?php
      ...
      <p><a href="<?php echo base_url();?>Kehoach_C" target="_blank">Nhật ký hành trình</a></p>
       <p><a href="<?php echo base_url();?>Kehoach_C" target="_blank">Tư vấn hành trình du lịch</a></p>
